 ...
 * Ajustado para garantir que a grade de dias e cabeçalhos não fiquem encavalados.
 */
function Calendar({
  className,
  classNames,
    ...
    <DayPicker
      ...
      classNames={{
        ...
        day_button: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-accent/10 hover:text-accent"
        ),
