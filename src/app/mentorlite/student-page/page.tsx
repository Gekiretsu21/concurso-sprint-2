    ...
    <div className="flex flex-col gap-8 max-w-5xl mx-auto pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <section className="lg:col-span-2">
          <Card className="border-accent/20 shadow-xl shadow-black/5 bg-white overflow-hidden">
        ...
        <section className="space-y-6">
          <Card className="border-accent/40 shadow-xl bg-gradient-to-b from-white to-slate-50 overflow-hidden ring-1 ring-accent/20">
