    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col items-center gap-6">
        <div className="relative w-full max-w-4xl group">
            <div className="relative z-10 h-full flex flex-col bg-gradient-to-r from-green-900 via-blue-400 to-blue-900 border border-white/10 p-8 min-h-[120px] rounded-3xl shadow-lg shadow-black/30 transition-transform duration-300 group-hover:scale-[1.02] group-hover:border-white/20">
